...
| `CAP-019` | *planned* | Pixel 7a | TBD | TBD | TBD | C | `CONV-001`, `MULTI-001` | Main run-through group, never yet captured — Conversation Detection and Multipoint on/off toggles | — | — | planned |
| `CAP-020` | *planned* | Pixel 7a | TBD | TBD | TBD | F | `TOUCH-001`, `HEAD-001` | Main run-through group, never yet captured — Touch controls and Head gestures top-level on/off toggles; run before `CAP-028` (Group O), which requires Head gestures enabled | — | — | planned |
| `CAP-021` | *planned* | Pixel 7a | TBD | TBD | TBD | G | `HOLD-001`–`HOLD-005` | Main run-through group, never yet captured — per-earbud press-and-hold configuration and ANC-mode rotation list | — | — | planned |
| `CAP-022` | *planned* | Pixel 7a | TBD | TBD | TBD | H | `AUDIO-001`–`AUDIO-003` | Main run-through group, never yet captured — Mono audio, Volume EQ, Volume balance | — | — | planned |
| `CAP-023` | *planned* | Pixel 7a | TBD | TBD | TBD | I | `FW-001`–`FW-004` | Main run-through group, never yet captured — firmware/device-info screen; also the capture design that records the app's own on-screen firmware version alongside the wire capture, per `PROTOCOL.md` §0.1's open wire-baseline-firmware-version question | — | — | planned |
| `CAP-024` | *planned* | Pixel 7a | TBD | TBD | TBD | J | `INEAR-001`, `CASE-001`, `CASE-002` | Main run-through group, never yet captured — In-ear detection toggle and case-sound settings | — | — | planned |
| `CAP-025` | *planned* | Pixel 7a | TBD | TBD | TBD | K | `FIND-001`–`FIND-004` | Main run-through group, never yet captured — Find My Buds/Ring, the last remaining fully unattributed app command; `PROTOCOL.md` §4.4 has a concrete, testable hypothesis ready to check | — | — | planned |
...
| `CAP-027` | *planned* | either phone | TBD | TBD | TBD | N | `TOUCH-002`–`TOUCH-007` | Main run-through group, never yet captured — physical touch gestures on the bud hardware; `TOUCH-007`'s behavior depends on the per-earbud mode set in `CAP-021` (Group G) | — | — | planned |
