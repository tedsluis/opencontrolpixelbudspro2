...
- **Update (2026-09-20, `ai-sessions/0042`) — 🟢 FACT for this capture: on the wire, not deliverable to the app; the app-side route was removed.** `CAP-059`: `tshark -Y bthfp`
...
- **Update (2026-09-20, `ai-sessions/0042`; 🟡/🟢 as labelled, no promotion):** in `CAP-059` the phone side (Play services; the app never opens it) opened DLCI 0x08 five times
...
- **Update (2026-09-22, `ai-sessions/0043`; 🟢 FACT, maintainer-approved in chat 2026-09-22, per `AGENTS.md` §6) — the Buds push `Group 0x0e Code 0x01` without a
  phone-side `0e 04` request.** `CAP-060` shows ≥13 unprompted pushes across a 408s session (frames 1307/1308, 1653, 2309/2310, 2628, 2927/2928, 3064/3065, 4853/4856,
  5038/5041, 5167/5168, 5849/5856, 6091, 6857/6859), all received by Google Play services (not the app — every one of the app's own 8 DLCI 0x08 claim attempts in that
