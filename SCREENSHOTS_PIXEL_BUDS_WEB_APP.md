# Pixel buds web app (Dutch)

Original screenshot pixel buds pro 2 web app (`http://mypixelbuds.google.com/`).

![image24](images/pixel_buds_web_app_1.png)
![image25](images/pixel_buds_web_app_2.png)
