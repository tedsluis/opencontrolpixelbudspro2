...
| 0022 | CAPTURE | 2026-09-15 | Full, non-sampled log analysis and FINDINGS for CAP-047 (Group AL, DLCI 0x0a burst trigger hypothesis test), plus targeted video re-check of a recalled corrected docking in Recording 2 | partial — 2 of 4 proposals resolved (reconciled 2026-09-18, `ai-sessions/0031`): `CASE-009` Test-ID registered; the Recording-1-vs-2 swapped-dock ADR-016 disconnect-inconsistency remains a genuinely open research question, and a formal `DECISIONS.md` ADR-024 text update (folding in 2 new counter-examples) still awaits a maintainer decision |
