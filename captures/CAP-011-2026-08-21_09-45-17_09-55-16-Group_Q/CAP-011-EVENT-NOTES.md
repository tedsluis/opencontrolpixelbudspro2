...
| 09:45:47–09:55:16 | "Device details" screen left open and idle for the remainder of the video, no further taps | User (idle) | `BATT-002`, `BATT-003` | Fast Pair Service (UUID `0xFE2C`) BLE advertisements continue throughout — see §Decode |
