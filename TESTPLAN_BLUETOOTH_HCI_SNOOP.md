...
|---|---|---|---|---|---|---|
| `ANC-001` | ANC → Off | User (App) | B | 🟢 | | `PROTOCOL.md` §4.1; also `CAP-059`, `CAP-060` (`ai-sessions/0043`, app-validation runs) |
| `ANC-002` | ANC → Noise Cancellation | User (App) | B | 🟢 | Sends a configuration command to the buds. | `PROTOCOL.md` §4.1; also `CAP-059`, `CAP-060` |
| `ANC-003` | ANC → Adaptive | User (App) | B | 🟢🔵 | Pro 2-specific; added in firmware 4.467 (Sept. 2025). Automatically adjusts volume to the environment. | `PROTOCOL.md` §4.1; also `CAP-059`, `CAP-060` |
| `ANC-004` | ANC → Transparency | User (App) | B | 🟢 | | `PROTOCOL.md` §4.1; also `CAP-059`, `CAP-060` |
...
| `FIND-001` | Play sound on Left earbud ('Find My Buds') | User (App) | K | 🔵🟡 | Via Find Device/Find Hub integration in the app; individually addressable per component. | `PROTOCOL.md` §4.4; also `CAP-059`, `CAP-060` (`ai-sessions/0043`) |
| `FIND-002` | Play sound on Right earbud | User (App) | K | 🔵🟡 | | `PROTOCOL.md` §4.4; also `CAP-059`, `CAP-060` |
