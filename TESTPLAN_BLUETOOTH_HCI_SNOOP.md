...
|---|---|---|---|---|---|---|
| `ANC-001` | ANC → Off | User (App) | B | 🟢 | | `PROTOCOL.md` §4.1; also `CAP-059`, `CAP-060` (`ai-sessions/0043`, app-validation runs); `CAP-061`: attempted, nothing sent (Safe Mode, `CAP-061-FINDINGS.md` §1) |
| `ANC-002` | ANC → Noise Cancellation | User (App) | B | 🟢 | Sends a configuration command to the buds. | `PROTOCOL.md` §4.1; also `CAP-059`, `CAP-060`; `CAP-061`: attempted, nothing sent (Safe Mode, `CAP-061-FINDINGS.md` §1) |
| `ANC-003` | ANC → Adaptive | User (App) | B | 🟢🔵 | Pro 2-specific; added in firmware 4.467 (Sept. 2025). Automatically adjusts volume to the environment. | `PROTOCOL.md` §4.1; also `CAP-059`, `CAP-060`; `CAP-061`: attempted, nothing sent (Safe Mode, `CAP-061-FINDINGS.md` §1) |
| `ANC-004` | ANC → Transparency | User (App) | B | 🟢 | | `PROTOCOL.md` §4.1; also `CAP-059`, `CAP-060`; `CAP-061`: attempted, nothing sent (Safe Mode, `CAP-061-FINDINGS.md` §1) |
...
| `FIND-001` | Play sound on Left earbud ('Find My Buds') | User (App) | K | 🔵🟡 | Via Find Device/Find Hub integration in the app; individually addressable per component. | `PROTOCOL.md` §4.4; also `CAP-059`, `CAP-060` (`ai-sessions/0043`); `CAP-061`: attempted, nothing sent (Safe Mode, `CAP-061-FINDINGS.md` §1) |
| `FIND-002` | Play sound on Right earbud | User (App) | K | 🔵🟡 | | `PROTOCOL.md` §4.4; also `CAP-059`, `CAP-060`; `CAP-061`: attempted, nothing sent (Safe Mode, `CAP-061-FINDINGS.md` §1) |
...
| `CASE-004` | Remove Left earbud from the case | User (Hardware) | M | 🔵 | Changes state to 'out of case'. | —; `CAP-061` (Left out 17:26:51–52, battery flag `64 64` frame 3233) |
| `CASE-005` | Remove Right earbud from the case | User (Hardware) | M | 🔵 | | —; `CAP-061` (Right out 17:26:36–37, battery flag `e4 64` frame 3146) |
...
| `CASE-006` | Place buds back in the case and close the lid | User (Hardware) | M | 🔵 | Terminates the active Bluetooth Classic connection. | —; `CAP-061` (second bud seated → ACL `0x13` frame 5597; lid closed → 6068) |
